...
DATASET_MODULES = {
    ...
    # 新增旋转版本的RatioDataSetTVResize及其test
    'RotateRatioDataSetTVResize': 'tools.data.rotate_ratio_dataset_tvresize',
    'RotateRatioDataSetTVResizeTest': 'tools.data.rotate_ratio_dataset_tvresize_test',
    # 新增label版本的RatioDataSetTVResize，专门用于打标，训练阶段不使用
    'RotateRatioDataSetTVResizeLabel': 'tools.data.rotate_ratio_dataset_tvresize_label',
